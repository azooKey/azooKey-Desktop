...
extension Config.Deprecated {
    ...
    struct TypeCommaAndPeriod: BoolConfigItem {
        ...
        static let key: String = "dev.shintok.inputmethod.azooKeyMac.preference.typeCommaAndPeriod"
    }
    ...
    struct ZenzaiIntegration: BoolConfigItem {
        ...
        static let key: String = "dev.shintok.inputmethod.azooKeyMac.preference.enableZenzai"
    }
    ...
    struct EnableOpenAiApiKey: BoolConfigItem {
        static let `default` = false
        static let key: String = "dev.shintok.inputmethod.azooKeyMac.preference.enableOpenAiApiKey"
    }
}
